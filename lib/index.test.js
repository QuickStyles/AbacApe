...
describe('AbacApe at runtime', () => {
  ...
  describe('checkPolicy', () => {
    describe('given passing subject/action/resource/environment', () => {
      const human_instance = new Human(1, 'bobby', 'lee', 23);
      const animal_instance = new Animal(1, 'winston', 'dog', 'male');
    ...
    describe('given failing subject/action/resource/environemnt', () => {
      const human_instance = new Human(2, 'kanye', 'west', 30);
      const animal_instance = new Animal(1, 'south', 'tiger', 'female');
